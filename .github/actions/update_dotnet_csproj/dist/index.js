...
var xml2js = __nccwpck_require__(2968);
var xml2json = __nccwpck_require__(7207);
var js2xml = __nccwpck_require__(692);
var json2xml = __nccwpck_require__(1008);
...
var helper = __nccwpck_require__(9557);
var isArray = (__nccwpck_require__(3225).isArray);
...
var sax = __nccwpck_require__(4624);
...
const convert = __nccwpck_require__(4105)
...
class DotnetParser extends CoreParser {
    ...
    async collect_data(packageName) {
        const reg_versions = new RegExp(`<title type="text">${packageName} \\d+.\\d+.\\d+<\\/title>`, 'gm');
...
const path = __nccwpck_require__(1017)
const DotnetParser = __nccwpck_require__(3135);
const install = __nccwpck_require__(2859);
